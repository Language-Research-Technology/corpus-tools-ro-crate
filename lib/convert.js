...
async function convertRoCrateToOcfl(options) {
    ...
    const resolvedMainPackage = mainPackage || Collector.mainPackage;
    if (!resolvedMainPackage) throw new Error('mainPackage is required (pass it or set Collector.mainPackage)');
    ...
    Collector.mainPackage = resolvedMainPackage;
